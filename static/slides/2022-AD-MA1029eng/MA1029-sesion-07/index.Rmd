...
1. We derive partialy and solve the equation $f_x(x,y)=0$ and $f_y(x,y)=0.$
 $$f_x(x,y)=2x-2=0\Rightarrow x=1$$
$$f_y(x,y)=2y+6=0 \Rightarrow y=-3$$

<br/><br/>

2. We derive partialy and solve the equation $g_x(x,y)=0$ and $g_y(x,y)=0.$
...
--
1. We need to determine the objective function: $$V(x,y,z)=xyz$$ but $2xz+2yz+xy=12$ by hipothesis, then $$z=\frac{12-xy}{2(x+y)}$$
...
3. Those equations imply that $x^2=y^2,$ and as they are measures then $x=y.$ Then $$12-3x^2=0\Rightarrow x=y=2$$ and $$z=\frac{12-(2)(2)}{2(2+2)}=1.$$
---
