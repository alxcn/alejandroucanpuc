...
> **Definition:** If $(u,v)$ is a direction in $\mathbb{R}^2,$ $f(x,y)$ is a function and $p=(x_0,y_0)$ then the __directional derivative__ of $f$ at the point $p$ and direction $(u,v)$ is the derivative of the function $f$ with the change of variable $$x(t)=x_0+ut\,quad y(t)=y_0+vt,$$ and is denoted by $D_{(u,v)}f(p).$
--
...
<br/><br/>
  * $x(t)=1+\frac{3}{2}t$ y $y(t)=1+2t,$ we have that $h_t(0)=\frac{-13\sin(2)}{2}\approx -5.91$ <br/><br/>
  * $x(t)=1+\frac{3}{5}t$ y $y(t)=1+\frac{4}{5}t,$ we have that $h_t(0)=-\frac{13 \sin(2)}{5}\approx -2.36$ <br/><br/>
  * $x(t)=1+t$ y $y(t)=1+\frac{4}{3}t,$ we have that $h_t(0)=\frac{-13\sin(2)}{3}\approx -3.94$ <br/><br/>
